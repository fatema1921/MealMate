...
router.post('/:id/ingredients/:ingredientId', recipeController.addIngredientToRecipe); // Post a new ingredient to a specific recipe
router.get('/ingredients/:ingredientId', recipeController.getRecipesByIngredient); // Get recipes with a specific ingredient 
router.patch('/:id', recipeController.patchRecipe); //  Update some fields for a specific recipe

router.get('/:id/ingredients/:ingredientId', recipeController.getIngredientById);

router.delete('/:id/ingredients/:ingredientId', recipeController.deleteIngredientById);
